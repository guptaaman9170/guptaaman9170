...
ROWS = [
    ...
    ("kv", "Back-End", "Node.js, Express.js, FastAPI, Socket.IO, SSE."),
    ("kv", "Front-End", "React.js, Tailwind CSS, TypeScript, Vite."),
    ("kv", "DevOps/DB", "MongoDB, Postgres, Docker, GridFS, CI/CD."),
    ("gap",),
    ("sec", "Highlights"),
