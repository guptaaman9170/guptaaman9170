...
# ===========================================================================
#  Aman Kumar Gupta's info panel.
#  The username in the header is HOST below.
#
#  row types:
#    ("host",)              -> "aman@github" header + rule
...
# ===========================================================================
HOST = "aman"   # shown as aman@github in the header

ROWS = [
    ("host",),
    ("kv", "Role", "Full Stack & Agentic AI Developer"),
    ("kv", "Prev", "Full Stack Web Dev Intern @ AI Ally"),
    ("kv", "Edu", "B.Tech CSE, IIIT Bhagalpur '27 (8.49)"),
    ("kv", "Focus", "Agentic AI, LangGraph.js & Real-Time REST"),
    ("gap",),
    ("sec", "Stack"),
    ("kv", "AI / LLMs", "LangGraph.js, LangChain, Gemini, OpenAI, RAG."),
    ("kv", "Back-End", "Node.js, Express.js, Flask, Socket.IO, SSE."),
    ("kv", "Front-End", "React.js, Tailwind CSS, JavaScript (ES6+)."),
    ("kv", "DevOps/DB", "MongoDB, Docker, GridFS, Postman, Git CI/CD."),
    ("gap",),
    ("sec", "Highlights"),
    ("bul", "Solved 1000+ DSA & CP (CF Pupil 1213, CC 3★ 1625)."),
    ("bul", "National Finalist @ Idea One Hackathon (Top 1%)."),
    ("bul", "5th Rank Nationwide @ Jaipur Cybrathon 2K25."),
]
